...
Version  : 0.8.1
Release  : 9
URL      : https://cran.r-project.org/src/contrib/flextable_0.8.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/flextable_0.8.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663606344
