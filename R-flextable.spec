...
Version  : 0.8.5
Release  : 14
URL      : https://cran.r-project.org/src/contrib/flextable_0.8.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/flextable_0.8.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675097939
...
/usr/lib64/R/library/flextable/web_1.1.2/tabwid.css
