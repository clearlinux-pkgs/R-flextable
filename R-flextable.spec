...
Source0  : https://cran.r-project.org/src/contrib/flextable_0.8.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677187537
...
/usr/lib64/R/library/flextable/tests/testthat/rmd/keep-next.Rmd
